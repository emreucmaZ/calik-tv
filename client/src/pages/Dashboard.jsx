    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-400 text-sm mt-1">
            ÇALIK TV yayın kontrol merkezi
          </p>
        </div>
          ...
          <div className="bg-slate-900/50 rounded-xl aspect-video flex items-center justify-center border border-slate-700/50">
            <div className="text-center">
              ...
              <p className="text-slate-400 mb-4">
                OBS'den gelen yayını izlemek için
              </p>
              <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div
          className={`card p-6 ${
            status?.isStreaming
              ? "bg-gradient-to-br from-red-600/20 to-red-700/20 border-red-500/30"
              : ""
          }`}
        >
          <div className="flex items-start justify-between">
            <div>
              ...
              <p
                className={`text-3xl font-bold mt-2 ${
                  status?.isStreaming ? "text-red-400" : "text-white"
                }`}
              >
            ...
            <div
              className={`w-12 h-12 rounded-xl flex items-center justify-center ${
                status?.isStreaming ? "bg-red-500/20" : "bg-slate-700/50"
              }`}
            >
              {status?.isStreaming ? (
        ...
        <div className="card p-6">
          <div className="flex items-start justify-between">
            <div>
              ...
              <Link
                ...
                className={`btn mt-4 inline-flex items-center ${
                  status?.isStreaming ? "btn-danger" : "btn-success"
                }`}
              >
                {status?.isStreaming ? (
                  <>
            ...
            <div
              className={`w-12 h-12 rounded-xl flex items-center justify-center ${
                status?.isStreaming ? "bg-red-500/20" : "bg-green-500/20"
              }`}
            >
              <svg
                className={`w-6 h-6 ${
                  status?.isStreaming ? "text-red-400" : "text-green-400"
                }`}
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
